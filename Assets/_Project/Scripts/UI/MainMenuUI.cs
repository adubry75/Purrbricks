...
public class MainMenuUI : MonoBehaviour
{
    ...
    private void BuildUI()
    {
        ...
        UIStyle.CreateButton(_panel.transform, "High Scores", new Vector2(0f, -170f), new Vector2(360f, 84f), () => GameManager.Instance?.ShowHighScores(), UIStyle.AccentBlue);
        UIStyle.CreateButton(_panel.transform, "Settings",    new Vector2(0f, -255f), new Vector2(360f, 84f), () => GameManager.Instance?.ShowSettings(fromPause: false), UIStyle.AccentBlue);
        UIStyle.CreateButton(_panel.transform, "Quit",        new Vector2(0f, -340f), new Vector2(360f, 84f), QuitGame, UIStyle.AccentRed);
#if UNITY_EDITOR
